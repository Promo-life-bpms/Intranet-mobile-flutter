...
class SkeletonHeaderLine extends StatelessWidget {
  final SkeletonHeaderLineStyle style;
  const SkeletonHeaderLine({Key? key, this.style = const SkeletonHeaderLineStyle()})
      : super(key: key);
