                      ...
                      children: [
                        SizedBox(
                          ...
                          child:FittedBox(
                            fit: BoxFit.contain,
                            child: Image(
                                image: NetworkImage(ApiIntranetConstans.baseUrl+_communiqueModel![index].image),
                              )
                          ),
                        ),
                        const  Padding( 
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.of(context).push(MaterialPageRoute(builder: (context) => Image(image: NetworkImage(ApiIntranetConstans.baseUrl+_communiqueModel![index].image))));
                            },
