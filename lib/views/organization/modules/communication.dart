...
class CommunicationDirectoryPage extends StatefulWidget {
  const CommunicationDirectoryPage({Key? key}) : super(key: key);

  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<CommunicationDirectoryPage> {
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return 
                    _directoryModel![index].department =="Comunicacion"
                    ?Card(
