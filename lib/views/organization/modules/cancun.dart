...
void main() => runApp( CancunDirectoryPage(directoryModel: [],));


class CancunDirectoryPage extends StatelessWidget {
   CancunDirectoryPage({Key? key, required this.directoryModel}) : super(key: key);
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return 
                    directoryModel![index].department =="Cancun"
                    ?Card(
