...
class TechnologyDirectoryPage extends StatefulWidget {
  const TechnologyDirectoryPage({Key? key}) : super(key: key);

  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<TechnologyDirectoryPage> {
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return 
                    _directoryModel![index].department =="Tecnologia e Innovacion"
                    ?Card(
