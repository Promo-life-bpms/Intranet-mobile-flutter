...
class ManagementDirectoryPage extends StatefulWidget {
  const ManagementDirectoryPage({Key? key}) : super(key: key);

  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<ManagementDirectoryPage> {
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return 
                    _directoryModel![index].department =="Administracion"
                    ?Card(
