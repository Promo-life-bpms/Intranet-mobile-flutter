...
void main() => runApp( ManagementDirectoryPage(directoryModel: [],));

class ManagementDirectoryPage extends StatelessWidget {
   ManagementDirectoryPage({Key? key, required this.directoryModel}) : super(key: key);
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return 
                    directoryModel![index].department =="Administracion"
                    ?Card(
