...
void main() => runApp( LogisticsDirectoryPage(directoryModel: [],));

class LogisticsDirectoryPage extends StatelessWidget {
   LogisticsDirectoryPage({Key? key, required this.directoryModel}) : super(key: key);
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return 
                    directoryModel![index].department =="Logistica"
                    ?Card(
